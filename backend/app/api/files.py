...
async def get_file_detail(
    ...
    return FileDetailResponse(
        ...
        has_video_preview=media_file.video_preview_path is not None,
        size_bytes=media_file.size_bytes,
        thumbnail_url=f"/api/thumbnails/{media_file.id}",
        preview_url=f"/api/previews/{media_file.id}",
        video_preview_url=f"/api/video-preview/{media_file.id}" if media_file.video_preview_path else None,
